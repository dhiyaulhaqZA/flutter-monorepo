...
class Currency {
  static getDeviceCurrencyCode() {
    String deviceCountryCode =
        WidgetsBinding.instance.window.locale.countryCode ?? "AS";
    String currencyCode =
        Currency.getCountryByIsoCode(deviceCountryCode).currencyCode;
    return currencyCode;
  }
...
class Country {
  ...
  factory Country.fromMap(Map<String, String> map) => Country(
        isoCode: map['isoCode'] ?? "AS",
        currencyCode: map['currencyCode'] ?? "USD",
        currencyName: map['currencyName'] ?? "United State Dollar",
        name: map['name'] ?? "American Samoa",
        iso3Code: map['iso3Code'] ?? "ASM",
      );
}
